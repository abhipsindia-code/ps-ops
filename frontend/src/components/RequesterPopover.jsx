  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "12px 14px" }}>
        {contact.phone && (
          <div style={{ fontSize: "14px", marginBottom: "6px", color: "#111827" }}>
            📞 {contact.phone}
          </div>
        )}

        {contact.email && (
          <div style={{ fontSize: "13px", marginBottom: "12px", color: "#6b7280" }}>
            ✉️ {contact.email}
          </div>
        )}
